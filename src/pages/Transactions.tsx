...
const Transactions = () => {
  ...
  <div className="flex flex-col items-center justify-center mt-16 bg-gray-100 p-6 rounded-lg shadow-lg">
    <svg
    ...
    <p className="text-gray-500 text-center max-w-xs mb-4">
      It looks like you haven't made any transactions yet. Start by browsing
      our listings or making a booking.
    </p>
    <button
      className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition-all duration-300 shadow-md"
